...
import { usePanelKitLanding } from '@/lib/panelkit-content'
...
export function LandingNavbar() {
  ...
  const content = usePanelKitLanding()
  const brand = content.brand || 'ShadcnStore'
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        ...
        <div className="hidden xl:flex items-center space-x-2">
          ...
          <Button variant="ghost" asChild className="cursor-pointer">
            <a href={content.loginHref || getAppUrl("/auth/sign-in")}>Sign In</a>
          </Button>
          <Button asChild className="cursor-pointer">
            <a href={content.registerHref || getAppUrl("/auth/sign-up")}>Get Started</a>
          </Button>
        </div>
            ...
            <div className="flex flex-col h-full">
              ...
              <SheetHeader className="space-y-0 p-4 pb-2 border-b">
                <div className="flex items-center gap-2">
                  ...
                  <SheetTitle className="text-lg font-semibold">{brand}</SheetTitle>
